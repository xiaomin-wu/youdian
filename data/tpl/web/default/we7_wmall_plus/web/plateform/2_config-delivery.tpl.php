			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline"><input type="radio" name="mobile_verify_status" value="1" <?php  if($config_delivery['mobile_verify_status'] == 1) { ?>checked<?php  } ?>> 验证手机号</label>
						<label class="radio-inline"><input type="radio" name="mobile_verify_status" value="2" <?php  if($config_delivery['mobile_verify_status'] == 2 || !$config_delivery['mobile_verify_status']) { ?>checked<?php  } ?>> 不验证</label>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<div class="input-group">
							<input type="text" name="get_cash_fee_limit" value="<?php  echo $config_delivery['get_cash_fee_limit'];?>" class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<div class="input-group">
							<input type="text" name="get_cash_fee_rate" value="<?php  echo $config_delivery['get_cash_fee_rate'];?>" class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<div class="input-group">
							...
							<input type="text" name="get_cash_fee_min" value="<?php  echo $config_delivery['get_cash_fee_min'];?>" class="form-control"/>
							<span class="input-group-addon">元</span>
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">最高</span>
							<input type="text" name="get_cash_fee_max" value="<?php  echo $config_delivery['get_cash_fee_max'];?>" class="form-control"/>
							<span class="input-group-addon">元</span>
						</div>
						<div class="help-block">
