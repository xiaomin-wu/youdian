		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="content" value="<?php  echo $config['content'];?>" class="form-control">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>未关注提示</label>
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" value="1" name="follow_guide_status" <?php  if($config['follow_guide_status'] == 1) { ?>checked<?php  } ?>> 提示
						</label>
						<label class="radio-inline">
							<input type="radio" value="0" name="follow_guide_status" <?php  if(!$config['follow_guide_status']) { ?>checked<?php  } ?>> 不提示
						</label>
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>首页商家排序方式</label>
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" value="displayorder" name="store_orderby_type" <?php  if($config['store_orderby_type'] == 'displayorder') { ?>checked<?php  } ?>> 按排序大小排序
						</label>
						<label class="radio-inline">
							<input type="radio" value="click" name="store_orderby_type" <?php  if($config['store_orderby_type'] == 'click') { ?>checked<?php  } ?>> 按热度排序
						</label>
						<label class="radio-inline">
							<input type="radio" value="distance" name="store_orderby_type" <?php  if($config['store_orderby_type'] == 'distance') { ?>checked<?php  } ?>> 离我最近
						</label>
						<label class="radio-inline">
							<input type="radio" value="sailed" name="store_orderby_type" <?php  if($config['store_orderby_type'] == 'sailed') { ?>checked<?php  } ?>> 销量最高
						</label>
						<label class="radio-inline">
							<input type="radio" value="score" name="store_orderby_type" <?php  if($config['store_orderby_type'] == '	score') { ?>checked<?php  } ?>> 评分最高
						</label>
						<div class="help-block text-danger">
							<strong class="text-danger">热度: 体现在粉丝在点击“搜索”菜单时，系统会按照热度有大到小列出5个商家。</strong>
							<strong class="text-danger">推荐: 体现在粉丝搜索门店或菜品时，在搜索结果下面会列出平台推荐的商家。</strong>
						</div>
					</div>
				</div>
			</div>
