	...
	<?php  } else { ?>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="javascript:;" target="_blank"><?php  echo $_W['we7_wmall_plus']['store']['title'];?></a>
					</li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php  echo $this->createWebUrl('clerk', array('op' => 'post', 'id' => $_W['we7_wmall_plus']['clerk_id']));?>" target="_blank"><i class="fa fa-weixin fa-fw"></i> 我的账号</a></li>
