...
<div class="clearfix">
	...
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> 更新时请注意备份网站数据和相关数据库文件！如有问题请联系QQ：10373458！
	</div>
		<?php  if($op == 'display') { ?>
<!--版本信息-->
<div class="box">
    ...
    <li>官方网站：<a href="http://www.010xr.com" class="blue">新睿社区</a></li>

    <li class="red">[当前系统版本]：新睿.微擎0.8 V <?php  echo $ver;?></li>
	<?php  if($lastver == $ver) { ?>
	<li class="red">[最新系统版本]：新睿.微擎0.8 V <?php  echo $ver;?> （恭喜, 你的程序已经是最新版本）</li>
	<?php  } ?>
	<?php  if($lastver != $ver) { ?>
	<li class="red">[下一个系统版本]：：新睿.微擎0.8 V <?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="chanage();" class="btn btn-primary">查看版本</button></li>
	...
	<div class="alert alert-danger">
		 <?php  if($domain_time == '0') { ?><i class="fa fa-exclamation-triangle"></i> 授权版本：授权已过期！<!-- WPA Button Begin -->
<!-- WPA Button End -->
        <?php  } else { ?>
           <i class="fa fa-refresh"></i> 授权版本：新睿.微擎0.8商业版 &nbsp;更新服务截止：(<?php  echo date("Y-m-d", $domain_time);?>)
		 <?php  } ?>
		</div>
...
<div class="box">
	...
	<p class="red"><i class="fa fa-refresh"></i> [待更新的程序版本]：新睿.微擎0.8 V <?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="disp_confirm();" class="btn btn-primary" >在线升级</button></p>
	<script type="text/javascript">
