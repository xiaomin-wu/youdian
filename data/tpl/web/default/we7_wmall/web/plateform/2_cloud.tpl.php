				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<p class="form-control-static">
							<?php  if(!empty($cache) && $cache['auth_status'] == 1) { ?>
				...
				<?php  if(!empty($upgrade) && !empty($upgrade['upgrade'])) { ?>
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; 存在的新版本: <?php  echo $now_family?> <?php  echo $upgrade['version'];?></p>
							<?php  } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php  if(is_array($upgrade['scripts'])) { foreach($upgrade['scripts'] as $ver) { ?>
									<p class="form-control-static"><?php  echo $upgrade['family'];?><?php  echo $ver['version'];?> Build</p>
								<?php  } } ?>
							</div>
						</div>
					<?php  } ?>
