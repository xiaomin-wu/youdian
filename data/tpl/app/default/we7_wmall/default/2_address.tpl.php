						...
						<div class="item-content">
							<div class="item-inner">
								...
								<div class="item-input">
									...
									<a id="location" href="<?php  echo $this->createMobileUrl('address', array('op' => 'location', 'id' => $id, 'sid' => $_GPC['sid'], 'recordid' => $_GPC['recordid'], 'redirect_type' => $_GPC['redirect_type'], 'redirect_input' => $_GPC['redirect_input'], 'errander_id' => $_GPC['errander_id']));?>"><?php  if(!empty($address['address'])) { ?><?php  echo $address['address'];?><?php  } else { ?><span>点击添加地址(必填)</span><?php  } ?> <i class="icon fa fa-arrow-right pull-right"></i></a>
								</div>
							</div>
						</div>
					</li>
							...
							<div class="item-inner">
								<div class="row no-gutter">
									...
									<div class="col-20 address-edit">
										<a class="external" href="<?php  echo $this->createMobileUrl('address', array('op' => 'post', 'id' => $address['id'], 'sid' => $_GPC['sid'], 'redirect_type' => $_GPC['redirect_type'], 'redirect_input' => $_GPC['redirect_input'], 'recordid' => $_GPC['recordid']));?>"><img src="<?php echo MODULE_URL;?>resource/app/img/address_edit.png" alt="" /></a>
									</div>
								</div>
							</div>
						</li>
