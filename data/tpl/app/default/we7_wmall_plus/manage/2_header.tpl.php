...
<html>
	<head>
		...
		<title><?php  echo $_W['we7_wmall_plus']['config']['title'];?>-<?php  echo $title;?></title>
		...
		<link rel="stylesheet" href="../addons/we7_wmall_plus/resource/app/css/manage.css" />
		...
		<script type="text/javascript" src="../addons/we7_wmall_plus/resource/app/js/common.js"></script>
		<script type="text/javascript" src="../addons/we7_wmall_plus/resource/app/js/tiny.js?t=1111"></script>
	</head>
	<body>
