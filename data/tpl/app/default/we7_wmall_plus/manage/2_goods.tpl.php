...
<div class="page" id="page-manage-goods">
	...
	<div class="content">
		<div class="buttons-tab">
			<a href="<?php  echo $this->createMobileUrl('mggoods', array('status' => -1));?>" class="button <?php  if($status == -1 && empty($cid)) { ?>active<?php  } ?>">所有商品</a>
			...
			<ul>
				...
				<li class="border-1px-tb">
					...
					<div class="goods-btn border-1px-t">
						<a href="javascript:;" class="goods-del border-1px-r" data-id="<?php  echo $good['id'];?>">删除</a>
						<a href="javascript:;" class="goods-total-turncate border-1px-r" data-id="<?php  echo $good['id'];?>">清零</a>
...
<div class="popover popover-manage popover-goods-cagegory">
	...
	<div class="popover-inner" style="max-height: 400px">
		<div class="list-block">
			<ul>
				<li><a href="<?php  echo $this->createMobileUrl('mggoods', array('op' => 'list', 'cid' => 0));?>" class="list-button item-link border-1px-b">不限</a></li>
				<?php  if(is_array($categorys)) { foreach($categorys as $category) { ?>
					<li><a href="<?php  echo $this->createMobileUrl('mggoods', array('op' => 'list', 'cid' => $category['id']));?>" class="list-button item-link border-1px-b"><?php  echo $category['title'];?></a></li>
				<?php  } } ?>
			</ul>
		</div>
	</div>
